...
public class Literal extends ExprTree {
    ...
    */
     ...
     * Ex - 1+00:02:00
     */
    static Literal createRelTime(AMutableCharArrayString timeStr) throws HyracksDataException {
        Value val = new Value();
        ...
        if ((i.getIntegerValue() >= 0)
                && ((timeStr.charAt(i.getIntegerValue()) == 's') || (timeStr.charAt(i.getIntegerValue()) == 'S') || (Character
                        .isDigit(timeStr.charAt(i.getIntegerValue()))))) {
        ...
        if ((i.getIntegerValue() >= 0)
                && ((timeStr.charAt(i.getIntegerValue()) == 'm') || (timeStr.charAt(i.getIntegerValue()) == 'M') || (timeStr
                        .charAt(i.getIntegerValue()) == ':'))) {
            i.setValue(i.getIntegerValue() - 1);
        ...
        if ((i.getIntegerValue() >= 0)
                && ((timeStr.charAt(i.getIntegerValue()) == 'h') || (timeStr.charAt(i.getIntegerValue()) == 'H') || (timeStr
                        .charAt(i.getIntegerValue()) == ':'))) {
            i.setValue(i.getIntegerValue() - 1);
        ...
        if ((i.getIntegerValue() >= 0)
                && ((timeStr.charAt(i.getIntegerValue()) == 'd') || (timeStr.charAt(i.getIntegerValue()) == 'D') || (timeStr
                        .charAt(i.getIntegerValue()) == '+'))) {
            i.setValue(i.getIntegerValue() - 1);
    ...
    static Literal createLiteral(Value val) throws HyracksDataException {
    ...
    public void GetValue(Value val) throws HyracksDataException {
        ...
        if (val.isIntegerValue(i)) {
            if (factor != NumberFactor.NO_FACTOR) {
                val.setRealValue(((double) i.getLongValue()) * Value.ScaleFactor[factor.ordinal()]);
            }
