...
public class AMutableCharArrayString implements Comparable<AMutableCharArrayString>, CharSequence {
    ...
    public void erase(int position) {
        if (position == length - 1) {
            ...
            System.arraycopy(value, position + 1, value, position, this.length - (position + 1));
            this.length--;
        }
    }
    ...
    public void setValue(String otherString, int length) {
        ...
        System.arraycopy(otherString.toCharArray(), 0, value, 0, length);
        this.length = length;
    }
    ...
    public void insert(int i, String aString) {
        ...
        System.arraycopy(aString.toCharArray(), 0, value, i, aString.length());
        length += aString.length();
    }
